<div class="flex justify-between items-center ph2 ph4-ns fixed w-100 main-nav">
    ...
    <nav class="nav-links">
        <a class="ph2 ttu hov-s link f4 f6-ns col-grey @activeclass('about')"
           href="/about">About Us</a>
        <a class="ph2 ttu hov-s link f4 f6-ns col-grey @activeclass('services')"
           href="/services">Services</a>
        <a class="ph2 ttu hov-s link f4 f6-ns col-grey @activeclass('careers')"
           href="/careers">Careers</a>
        <a class="ph2 ttu hov-s link f4 f6-ns col-grey @activeclass('contact')"
