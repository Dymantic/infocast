<section class="pt6 pb4 relative">
    @include('svg-decorations.lines_3', ['classes' => 'dn db-ns decoration d-left d-top-30 h3'])
    @include('svg-decorations.dots_2', ['classes' => 'dn db-ns decoration d-right d-bottom-20 h3'])
